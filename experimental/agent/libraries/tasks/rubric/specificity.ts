...
export const specificity: Rubric = {
  name: "Specificity",
  description: "How fully specified a statement is.",
  scores: {
    1: {
      description:
        "The statement is extremely vague to the point of including no actual information.",
      examples: [
        "Marx was cool.",
        "Do the thing!",
    ...
    3: {
      description:
        "The statement contains some information but lacks precision in more than one aspect.",
      examples: [
    ...
    5: {
      description:
        "The statement simply cannot be expounded on further relative to its apparent purpose",
      examples: [
