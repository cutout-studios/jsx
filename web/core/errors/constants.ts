...
export const ERROR_CODE_MESSAGES = {
  ...
  [CutoutErrorCode.OPERATION_UNKNOWN]: "`@cutout/web` was requested to perform an unknown operation.",
  ...
  [CutoutErrorCode.HTTP_SERVER_ERROR]: "`@cutout/web` encountered a generic error while attempting to serve an HTTP resource.",
  [CutoutErrorCode.HTTP_NOT_IMPLEMENTED]: "`@cutout/web` HTTP resource not implemented.",
};
